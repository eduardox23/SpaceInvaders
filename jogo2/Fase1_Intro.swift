...
struct PhysicsCategory {
    ...
    static let TiroNave : UInt32 = 0b00001
    static let TiroInimigo : UInt32 = 0b00010
    static let Nave : UInt32 = 0b00100
    static let Inimigo : UInt32 = 0b01000
    static let LimiteY : UInt32 = 0b10000
}


class Fase1_Intro: SKScene{
    ...
    override func didMoveToView(view: SKView) {
        ...
        var acaoChamaFase1 = SKAction.sequence([SKAction.waitForDuration(1),SKAction.runBlock {
            var gameScene = Fase1(size: self.size)
